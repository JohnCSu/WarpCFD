...
class Ops:
    def __init__(self,cell_struct,face_struct,node_struct,cell_properties:cells_data,face_properties:faces_data,num_outputs:int,float_dtype = wp.float32,int_dtype = wp.int32):
